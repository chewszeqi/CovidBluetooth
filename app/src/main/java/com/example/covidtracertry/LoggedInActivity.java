        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                FirebaseDatabaseHelper.getInstance().updateUserStatus(strUserUID, statuses[picker.getValue()], new FirebaseDatabaseHelper.DataStatus() {
                    @Override
                    public void Success() {
                        Toast.makeText(com.example.covidtracertry.LoggedInActivity.this, "Updated status", Toast.LENGTH_LONG).show();
                    ...
                    @Override
                    public void Fail() {
                        Toast.makeText(com.example.covidtracertry.LoggedInActivity.this, "Failed to update status", Toast.LENGTH_LONG).show();
                        progressBar.setVisibility(View.GONE);
                        textTracking.setVisibility(View.VISIBLE);
                    }
                });
