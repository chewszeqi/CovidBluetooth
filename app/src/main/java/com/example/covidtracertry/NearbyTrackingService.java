...
import com.example.covidtracertry.models.Meet;
...
import static com.example.covidtracertry.Utils.writeToStorage;
...
public class NearbyTrackingService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Intent notificationIntent = new Intent(this, com.example.covidtracertry.LoggedInActivity.class);
