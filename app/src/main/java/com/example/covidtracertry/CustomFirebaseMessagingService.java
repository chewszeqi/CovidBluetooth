package com.example.covidtracertry;
...
import com.example.covidtracertry.dbhelpers.FirebaseDatabaseHelper;

import static com.example.covidtracertry.Utils.readFromStorage;
...
public class CustomFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(@NonNull RemoteMessage remoteMessage) {
        ...
        if (remoteMessage.getData().size() > 0) {
            ...
            Intent dialogIntent = new Intent(this, com.example.covidtracertry.MeetingActivity.class);
    ...
    private void sendNotification(String messageBody) {
        Intent intent = new Intent(this, com.example.covidtracertry.LoggedInActivity.class);
